...
"""https://stackoverflow.com/questions/53616039/how-to-use-shared-memory-instead-of-passing-objects-via-pickling-between-multipl"""
...
if __name__ == "__main__":
    ...
    with SharedMemoryManager() as smm:
        ...
        with ProcessPoolExecutor(cpu_count()) as exe:
            fs = [
                exe.submit(work_with_shared_memory, shm.name, shape, dtype)
