...
| Plugin or architecture decision | `docs/plans/` |
...
- `docs/IMPLEMENTATION_PLAN.md` — package split and stage breakdown
- `docs/plans/legacy/PLAN_msw_ui_agent_broadcast.md` — locked UI/agent architecture (Vue 3, PlotSpec, polling transport)
- `docs/concepts/plugin_system.md` — plugin entry-point contracts (`msw.host`, `msw.cli`)
- `docs/ROADMAP.md` — current TODO / DONE list
